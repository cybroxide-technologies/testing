...
<head>
    ...
    <title>Watchespati Foundation - Supporting Indian Army Legal Battles</title>
...
<body class="bg-gray-100">
    ...
    <section class="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-20">
        <div class="container mx-auto px-6 text-center">
            <h1 class="text-4xl font-bold mb-4">Supporting Indian Army Officials in Legal Battles</h1>
            <p class="text-xl mb-8">Watchespati Foundation provides legal assistance to those who protect our nation</p>
            <button class="bg-white text-blue-800 font-bold py-2 px-6 rounded-full hover:bg-blue-100">Learn More</button>
        </div>
    </section>
    ...
    <section class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold text-blue-800 mb-4">Legal Support</h2>
                <p class="text-gray-700">We provide comprehensive legal assistance to Indian Army officials facing legal challenges.</p>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold text-blue-800 mb-4">Advocacy</h2>
                <p class="text-gray-700">We advocate for policies that protect the rights and interests of military personnel.</p>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold text-blue-800 mb-4">Resources</h2>
                <p class="text-gray-700">Access legal resources, documents, and guidance for military legal proceedings.</p>
            </div>
        </div>
    </section>
    ...
    <div id="donateModal" class="modal">
        <div class="flex items-center justify-center min-h-screen">
            <div class="modal-content bg-white rounded-lg shadow-xl max-w-2xl w-full p-8 relative">
                ...
                <form id="donationForm" action="home.php" method="POST">
